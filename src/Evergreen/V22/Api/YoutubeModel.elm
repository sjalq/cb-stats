module Evergreen.V22.Api.YoutubeModel exposing (..)
...
type alias Video =
    ...
    , statsOnConclusion : Maybe Evergreen.V22.Json.Bespoke.VideoDecoder.Statistics
    , statsAfter24Hours : Maybe Evergreen.V22.Json.Bespoke.VideoDecoder.Statistics
