module Evergreen.V22.Pages.Playlist.Id_ exposing (..)
...
type Msg
    = GotVideos (Dict.Dict String Evergreen.V22.Api.YoutubeModel.Playlist) (Dict.Dict String Evergreen.V22.Api.YoutubeModel.Video) (Dict.Dict String Evergreen.V22.Api.YoutubeModel.LiveVideoDetails) (Dict.Dict ( String, Int ) Evergreen.V22.Api.YoutubeModel.CurrentViewers) (Dict.Dict String String)
    | GetVideos
