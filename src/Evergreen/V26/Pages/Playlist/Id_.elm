module Evergreen.V26.Pages.Playlist.Id_ exposing (..)
...
type Msg
    = GotVideos (Dict.Dict String Evergreen.V26.Api.YoutubeModel.Playlist) (Dict.Dict String Evergreen.V26.Api.YoutubeModel.Video) (Dict.Dict String Evergreen.V26.Api.YoutubeModel.LiveVideoDetails) (Dict.Dict ( String, Int ) Evergreen.V26.Api.YoutubeModel.CurrentViewers) (Dict.Dict String String)
    | GetVideos
