module Evergreen.V94.Bridge exposing (..)
...
type ToBackend
    = AttemptRegistration
        { email : Evergreen.V94.Api.User.Email
        , password : String
        }
    | AttemptSignIn
        { email : Evergreen.V94.Api.User.Email
    ...
    | UpdateSchedule Evergreen.V94.Api.YoutubeModel.Schedule
    | UpdatePlaylist Evergreen.V94.Api.YoutubeModel.Playlist
    | NoOpToBackend
