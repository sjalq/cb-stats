module Evergreen.V50.Api.YoutubeModel exposing (..)
...
type alias Video =
    ...
    , statsOnConclusion : Maybe Evergreen.V50.Json.Bespoke.VideoDecoder.Statistics
    , statsAfter24Hours : Maybe Evergreen.V50.Json.Bespoke.VideoDecoder.Statistics
