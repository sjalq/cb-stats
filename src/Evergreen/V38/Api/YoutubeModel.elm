module Evergreen.V38.Api.YoutubeModel exposing (..)
...
type alias Video =
    ...
    , statsOnConclusion : Maybe Evergreen.V38.Json.Bespoke.VideoDecoder.Statistics
    , statsAfter24Hours : Maybe Evergreen.V38.Json.Bespoke.VideoDecoder.Statistics
