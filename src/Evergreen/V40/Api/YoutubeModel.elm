module Evergreen.V40.Api.YoutubeModel exposing (..)
...
type alias Video =
    ...
    , statsOnConclusion : Maybe Evergreen.V40.Json.Bespoke.VideoDecoder.Statistics
    , statsAfter24Hours : Maybe Evergreen.V40.Json.Bespoke.VideoDecoder.Statistics
