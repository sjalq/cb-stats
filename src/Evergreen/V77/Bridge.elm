module Evergreen.V77.Bridge exposing (..)
...
type ToBackend
    = AttemptRegistration
        { email : Evergreen.V77.Api.User.Email
        , password : String
        }
    | AttemptSignIn
        { email : Evergreen.V77.Api.User.Email
    ...
    | UpdateSchedule Evergreen.V77.Api.YoutubeModel.Schedule
    | UpdatePlaylist Evergreen.V77.Api.YoutubeModel.Playlist
    | NoOpToBackend
