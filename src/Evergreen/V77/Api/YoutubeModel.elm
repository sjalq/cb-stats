module Evergreen.V77.Api.YoutubeModel exposing (..)
...
type alias Video =
    ...
    , statsOnConclusion : Maybe Evergreen.V77.Json.Bespoke.VideoDecoder.Statistics
    , statsAfter24Hours : Maybe Evergreen.V77.Json.Bespoke.VideoDecoder.Statistics
