module Evergreen.V77.Pages.Playlist.Id_ exposing (..)
...
type alias Model =
    ...
    , videoStats : Dict.Dict ( String, Int ) Evergreen.V77.Api.YoutubeModel.VideoStatisticsAtTime
    , competitorVideos : Dict.Dict String (Dict.Dict String Evergreen.V77.Api.YoutubeModel.Video)
    , currentIntTime : Int
...
type Msg
    = GotVideos Evergreen.V77.Api.YoutubeModel.VideoResults
    | GetVideos
